        ...
        return (
          ...
          (q.add = function (e, f, g, h) {
            ...
            if (
              ...
              e._time &&
                ((j = Math.max(0, Math.min(e.totalDuration(), (this.rawTime() - e._startTime) * e._timeScale))),
          ...
          (q.remove = function (b) {
            if (b instanceof a) {
              ...
              return (
                (b._startTime = (b._paused ? b._pauseTime : c._time) - (b._reversed ? b.totalDuration() - b._totalTime : b._totalTime) / b._timeScale), this
              );
            }
        ...
        (j = xa.prototype),
          (j.parseComplex = function (a, b, c, d, e, f) {
            var g,
              ...
              m = this.keyword;
            if (
              (this.multi && (I.test(c) || I.test(b) ? ((h = b.replace(I, '|').split('|')), (i = c.replace(I, '|').split('|'))) : m && ((h = [b]), (i = [c]))),
              i)
            ) {
            ...
            if (
              (Ca
                ...
                : a.currentStyle &&
                  ...
                  (d =
                    d && 4 === d.length ? [d[0].substr(4), Number(d[2].substr(4)), Number(d[1].substr(4)), d[3].substr(4), i.x || 0, i.y || 0].join(',') : '')),
                ...
                if (
                  ...
                  return void (B || P || L
                    ...
                    : (A[Ca] =
                        ...
                        ')'));
                if (
                  (n && ((q = 1e-4), q > E && E > -q && (E = G = 2e-5), q > F && F > -q && (F = G = 2e-5), !M || z.z || z.rotationX || z.rotationY || (M = 0)),
                  B || P)
                )
                  (B *= K),
                    (r = c = Math.cos(B)),
        ...
        ya('className', {
          parser: function (a, b, d, f, g, h, i) {
            ...
            return (
              (a._gsClassPT = g),
              (g.e =
                '=' !== b.charAt(1) ? b : o.replace(new RegExp('(?:\\s|^)' + b.substr(2) + '(?![\\w-])'), '') + ('+' === b.charAt(0) ? ' ' + b.substr(2) : '')),
  ...
  (function (a, b) {
    ...
    F(),
      ...
      (i.invalidate = function () {
        return (
          (this._time = this._totalTime = 0), (this._initted = this._gc = !1), (this._rawPrevTime = -1), (this._gc || !this.timeline) && this._enabled(!0), this
        );
      }),
      (i.isActive = function () {
        var a,
    ...
    var H = u(
        ...
        function (b, c, d) {
          ...
          if (
            ((this._overwrite = i = null == i ? W[H.defaultOverwrite] : 'number' == typeof i ? i >> 0 : W[i]),
    ...
    var _ = function (a, b, c) {
      ...
      ca = function (a, b, c) {
        ...
        return (
          (f /= e), f > b ? f - b : (c && f === b) || (!a._initted && 2 * n > f - b) ? n : (f += a.totalDuration() / a._timeScale / e) > b + n ? 0 : f - b - n
        );
      };
    (i._init = function () {
      var a,
      ...
      if (g.startAt) {
        ...
        if (this._startAt) this._startAt.render(-1, !0), this._startAt.kill(), (this._startAt = null);
          ...
          if (
            ((c.overwrite = 0), (c.data = 'isFromStart'), (c.lazy = j && g.lazy !== !1), (c.immediateRender = j), (this._startAt = H.to(this.target, 0, c)), j)
          ) {
        ...
        if (a >= i - 1e-7 && a >= 0)
          ...
          (this._totalTime = this._time = 0),
            ...
            0 > a &&
              ...
              0 === i &&
                (this._initted || !this.vars.lazy || c) &&
                (j >= 0 && (j !== n || 'isPause' !== this.data) && (c = !0), (this._rawPrevTime = g = !b || a || j === a ? a : n))),
      ...
      (i._kill = function (a, b, c) {
        ...
        if ((q(b) || I(b)) && 'number' != typeof b[0]) for (d = b.length; --d > -1; ) this._kill(a, b[d], c) && (i = !0);
          ...
          if (h) {
            if (
              ((j = a || h), (k = a !== e && 'all' !== e && a !== h && ('object' != typeof a || !a._tempKill)), c && (H.onOverwrite || this.vars.onOverwrite))
            ) {
      ...
      (i._enabled = function (a, b) {
        ...
        return (
          E.prototype._enabled.call(this, a, b), this._notifyPluginsOfEnabled && this._firstPT ? H._onPluginEvent(a ? '_onEnable' : '_onDisable', this) : !1
        );
      }),
      (H.to = function (a, b, c) {
        return new H(a, b, c);
