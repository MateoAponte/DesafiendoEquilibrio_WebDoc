...
!(function (e, r) {
  ...
  i.Scene.extend(function () {
    ...
    (i.addIndicators = function (e) {
      ...
      return (
        t ||
          ((r = { name: '', indent: 0, parent: void 0, colorStart: 'green', colorEnd: 'red', colorTrigger: 'blue' }),
          (e = v.extend({}, r, e)),
          h++,
          (t = new s(i, e)),
  ...
  var s = function (o, n) {
    ...
    b = {
      ...
      bounds: function () {
        ...
        return (
          v.css(e, { position: 'absolute', overflow: 'visible', 'white-space': 'nowrap', 'pointer-events': 'none', 'font-size': o }), (e.style.zIndex = n), e
        );
      },
      trigger: function (e) {
        var r = document.createElement('div');
