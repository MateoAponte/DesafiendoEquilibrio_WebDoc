          ...
          d[t] ||
            (d[t] = function (e) {
              return arguments.length
                ? ('duration' === t && (n = void 0),
                  x(t, e) && (d.trigger('change', { what: t, newval: h[t] }), ~D.shifts.indexOf(t) && d.trigger('shift', { reason: t })),
                  d)
                : h[t];
            });
        };
          ...
          m &&
            ...
            e || p !== f
              ? ((r = { position: w.inFlow ? 'relative' : 'absolute', top: 0, left: 0 }),
                ...
                w.pushFollowers
                  ? 0 < h.duration &&
                    ((p === u && 0 === parseFloat(R.css(w.spacer, 'padding-top'))) || (p === c && 0 === parseFloat(R.css(w.spacer, 'padding-bottom')))) &&
                    (o = !0)
  ...
  var R = (_._util = (function (s) {
    ...
    (e.extend = function (e) {
      for (e = e || {}, f = 1; f < arguments.length; f++)
        if (arguments[f]) for (var t in arguments[f]) arguments[f].hasOwnProperty(t) && (e[t] = arguments[f][t]);
      return e;
    }),
      ...
      (d.offset = function (e, t) {
        ...
        return (
          e &&
            ...
            ((n = e.getBoundingClientRect()), (r.top = n.top), (r.left = n.left), t || ((r.top += d.scrollTop()), (r.left += d.scrollLeft()))),
          r
        );
      }),
